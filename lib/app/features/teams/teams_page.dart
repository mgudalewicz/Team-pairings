...
class _TeamsPageState extends State<TeamsPage> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => TeamsCubit()..init(),
      child: BlocBuilder<TeamsCubit, TeamsState>(
        builder: (context, state) {
          ...
          if (state is TeamsInfoState) {
            final List players = state.players;
            ...
            return Scaffold(
              ...
              body: _buildView(players, checkBox, _meter, context),
            );
          }
                      ...
                      Flexible(
                        ...
                        children: [
                          Checkbox(
                              ...
                              value: checkBox.firstWhere((element) => element.title.contains(groupByValue)).value,
                              onChanged: (newValue) {
                                setState(() {
                                  _meter = 0;
